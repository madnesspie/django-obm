    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=12, help_text='The transaction amount in currency', max_digits=12)),
                ('fee', models.DecimalField(decimal_places=12, help_text='The amount of the fee in currency. This is negative and only available for the "send" category of transactions.', max_digits=12, null=True)),
                ('is_confirmed', models.BooleanField(default=False, verbose_name='confirmed')),
                ('timestamp', models.PositiveIntegerField(help_text='transaction creation timestamp', verbose_name='time')),
