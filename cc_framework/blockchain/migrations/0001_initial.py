# Generated by Django 3.0.4 on 2020-03-18 09:45
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "min_confirmations",
                    models.IntegerField(
                        help_text='Minimum confirmations number after which a transaction will get the status "is confirmed"'
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        choices=[("bitcoin-core", "bitcoin-core")],
                        max_length=200,
                        unique=True,
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="If True the node will be used as default for transaction sending",
                    ),
                ),
                (
                    "rpc_username",
            ...
            options={"unique_together": {("rpc_host", "rpc_port")},},
        ),
        migrations.CreateModel(
            name="Address",
            fields=[
            ...
            options={"unique_together": {("address", "currency")},},
        ),
        migrations.CreateModel(
            name="Transaction",
            fields=[
                ...
                (
                    "txid",
                    models.CharField(
                        max_length=500, null=True, verbose_name="transaction id"
                    ),
                ),
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=10,
                        help_text='The amount of the fee in currency. This is negative and only available for the "send" category of transactions.',
                        max_digits=19,
                        null=True,
                    ),
                ),
            ...
            options={"unique_together": {("node", "txid")},},
        ),
    ]
